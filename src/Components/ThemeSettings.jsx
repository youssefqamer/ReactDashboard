...
export default function ThemeSettings() {
  ...
  return (
    ...
    <div className="float-right h-screen data:text-gray-200 bg-white dark:[#484B52] w-400">
      <div className="flex justify-between items-center p-4 ml-4">
        <p className='font-semibold text-xl'>Settings</p>
        <button  type='button' onClick={()=>setThemeSettings(false)} style={{color:'rgb(153,171,181)', borderRadius:'50%'}}
